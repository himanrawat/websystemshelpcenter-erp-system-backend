...
const markAttendance = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const isSubject = yield db_config_1.default.subject.findUnique({
            where: {
        ...
        const attendanceExist = yield db_config_1.default.attendance.findFirst({
            where: {
                AND: [
                    {
                        date: formattedDate,
        ...
        yield db_config_1.default.attendance.createMany({
...
const updateAttendance = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield db_config_1.default.attendance.deleteMany({
            where: {
                AND: [
                    {
                        date: date,
...
const getPercentage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAttendanceOnADate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { date, subjectId } = req.params;
    try {
        // const formattedDate = format(date, "dd-MM-yyyy");
        const subject = yield db_config_1.default.subject.findUnique({
            where: {
                id: parseInt(subjectId),
            },
        });
        ...
        const presentStudents = yield db_config_1.default.attendance.findMany({
            where: {
                AND: [
                    { date: date },
...
const markFacultyAttendance = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const adminId = req.params.campusId;
    const { date, selectedTeachers } = req.body;
    try {
        const formattedDate = new Date(date);
        const isAttendanceExist = yield db_config_1.default.facultyAttendance.findUnique({
            where: {
                date: formattedDate,
            },
        });
        ...
        yield db_config_1.default.facultyAttendance.create({
            data: {
...
const getFacultyAttendance = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { onDate, campusId } = req.params;
        const date = onDate ? new Date(onDate) : new Date();
        const attendanceOfFaculty = yield db_config_1.default.facultyAttendance.findMany({
            where: {
                date: date,
...
const updateFacultyAttendance = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const adminId = req.params.campusId;
    const { date, selectedTeachers } = req.body;
    try {
        ...
        yield db_config_1.default.facultyAttendance.update({
            where: {
                date: formattedDate,
                adminId: parseInt(adminId),
            },
...
const getFacultyAttendanceById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const adminId = req.params.campusId;
...
const getAttendenceByDate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const adminId = req.params.campusid;
    ...
    try {
        ...
        const attendanceRecord = yield db_config_1.default.facultyAttendance.findFirst({
            where: {
                adminId: parseInt(adminId),
                date: {
                    gte: startDate,
