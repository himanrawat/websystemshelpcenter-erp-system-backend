...
const createDepartment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const newDepartment = yield db_config_1.default.department.create({
            data: {
                name,
                code,
                campusId: parseInt(campus_id),
...
const getDepartment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const departmentExist = yield db_config_1.default.department.findFirst({
            where: {
        ...
        const teachersData = departmentExist.teachers.map((teacher) => (Object.assign(Object.assign({}, teacher), { contactNumber: teacher.contactNumber.toString() })));
        const studentsData = departmentExist.students.map((student) => (Object.assign(Object.assign({}, student), { contactNumber: student.contactNumber.toString(), fatherContactNumber: student.fatherContactNumber.toString() })));
        return res.status(200).json({
            data: Object.assign(Object.assign({}, departmentExist), { teachers: teachersData, students: studentsData }),
...
const getAllDepartment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const departments = yield db_config_1.default.department.findMany({
            where: {
        ...
        const departmentsData = departments.map((department) => (Object.assign(Object.assign({}, department), { teachers: department.teachers.map((teacher) => (Object.assign(Object.assign({}, teacher), { contactNumber: teacher.contactNumber.toString() }))), students: department.students.map((student) => (Object.assign(Object.assign({}, student), { contactNumber: student.contactNumber.toString(), fatherContactNumber: student.fatherContactNumber.toString() }))) })));
        return res.status(200).json({
...
const deleteDepartment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!departmentExist)
        return res.status(404).json({ message: "Department does not exist!", success: false, });
    yield db_config_1.default.department.delete({
        where: {
            id: departmentId,
        },
    });
...
const updateDepartment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!findDepartment)
            return res.status(404).json({ message: "Department does not exist!", success: false, });
        yield db_config_1.default.department.update({
            where: {
                id: parseInt(depId),
            },
            data: {
