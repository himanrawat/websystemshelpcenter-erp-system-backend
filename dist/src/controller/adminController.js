...
const createAdmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const findAdmin = yield db_config_1.default.admin.findUnique({
            where: { email: email },
        });
        if (findAdmin) {
        ...
        const campus = yield db_config_1.default.campus.findUnique({
            where: {
                id: branch.campusId,
            },
        });
        ...
        const adminData = yield db_config_1.default.admin.update({
            where: {
                id: newAdmin.id,
            },
            data: {
        ...
        const otpResult = yield (0, helper_1.sendOtp)(email);
        ...
        return res.status(201).json({
            data: Object.assign(Object.assign({}, adminData), { password: "" }),
...
const verifyEmail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const admin = yield db_config_1.default.admin.findFirst({
        where: {
            id: parseInt(id),
        },
    });
    ...
    yield db_config_1.default.admin.update({
        where: {
            id: admin.id,
        },
        data: {
    ...
    yield db_config_1.default.otpToken.deleteMany({
        where: {
            email: admin.email,
        },
    });
...
const loginAdmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        let admin = yield db_config_1.default.admin.findUnique({
            where: {
                email: email,
            },
        });
...
//   }
// };
const fetchAdmins = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const showAdminById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const adminId = Number(req.params.id);
    try {
        const admin = yield db_config_1.default.admin.findFirst({
            where: {
...
const deleteAdmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const adminId = Number(req.params.id);
    const adminExist = yield db_config_1.default.admin.findUnique({
        where: {
            id: adminId,
        },
    });
    ...
    const adminDeleted = yield db_config_1.default.admin.delete({
        where: {
            id: adminId,
        },
    });
...
const forgetPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let user = yield db_config_1.default.admin.findUnique({
        where: {
            email: email,
        },
    });
    ...
    const reset_token = yield db_config_1.default.resetToken.findFirst({
        where: {
            ownerId: user.id,
        },
    });
    ...
    // else if
    if (reset_token && (reset_token === null || reset_token === void 0 ? void 0 : reset_token.expiresAt) < new Date()) {
    ...
    yield db_config_1.default.resetToken.create({
        data: {
            ownerId: user.id,
            token: rand_token,
            expiresAt: expiresAt,
...
const resetPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield db_config_1.default.resetToken.deleteMany({
            where: {
                ownerId: parseInt(id),
            },
        });
...
const createSupport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const newQuery = yield db_config_1.default.support.create({
            data: {
                name,
                email,
...
const createPayment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const payment = yield Promise.all(studentsData);
        console.log(payment);
        return res.status(200).json({
...
const createPaymentbyYear = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const department_id = req.params.dep_id;
