...
exports.supportTemplate = exports.leaveStatusEmail = exports.generateEmailTemplate = exports.changedPasswordEmailTemplate = exports.generatePasswordResetTemplate = exports.welcomeEmailTemplateForTeacher = exports.welcomeEmailTemplate = void 0;
...
const welcomeEmailTemplate = (heading, message) => {
    return `<!DOCTYPE html>
...
const welcomeEmailTemplateForTeacher = (heading, message) => {
    return `<!DOCTYPE html>
    <link rel="stylesheet" href="style.css" />
    <html lang="en">
      <head>
...
exports.welcomeEmailTemplateForTeacher = welcomeEmailTemplateForTeacher;
...
const changedPasswordEmailTemplate = (heading, content) => {
    return `<!DOCTYPE html>
    <html lang="en">
...
exports.changedPasswordEmailTemplate = changedPasswordEmailTemplate;
...
const leaveStatusEmail = (userName, leaveDate, leaveStatus, additionalMessage) => {
    return `<!DOCTYPE html>
  <html lang="en">
    <head>
      <meta charset="UTF-8" />
...
exports.leaveStatusEmail = leaveStatusEmail;
const supportTemplate = (complaintNo, name, email, contactNo, query) => {
    return `
      <!DOCTYPE html>
  <html lang="en">
  <head>
